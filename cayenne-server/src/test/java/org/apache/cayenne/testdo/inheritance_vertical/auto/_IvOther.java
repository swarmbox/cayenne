...
public abstract class _IvOther extends CayenneDataObject {
    ...
    public static final Property<List<IvCircle>> CIRCLES = new Property<List<IvCircle>>("circles");
    ...
    public List<IvCircle> getCircles() {
        return (List<IvCircle>)readProperty("circles");
    }
