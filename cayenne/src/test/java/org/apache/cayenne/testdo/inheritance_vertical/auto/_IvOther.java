...
public abstract class _IvOther extends PersistentObject {
    ...
    public static final EntityProperty<IvSub1Sub1> SUB1_SUB1 = PropertyFactory.createEntity("sub1Sub1", IvSub1Sub1.class);
    ...
    public void setSub1Sub1(IvSub1Sub1 sub1Sub1) {
        setToOneTarget("sub1Sub1", sub1Sub1, true);
    }

    public IvSub1Sub1 getSub1Sub1() {
        return (IvSub1Sub1)readProperty("sub1Sub1");
    }
